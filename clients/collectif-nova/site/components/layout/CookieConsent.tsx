...
const STORAGE_KEY = 'aura_cookie_consent_v1';
      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-4 px-6 py-5 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-wrap gap-3">
          <button
            ...
            className="rounded-full border border-primary-200 px-5 py-2 text-sm hover:bg-surface-alt transition-colors"
          >
            {t('reject_all')}
          </button>
          <button
            ...
            className="rounded-full bg-primary px-5 py-2 text-sm text-surface hover:bg-primary-600 transition-colors"
          >
            {t('accept_all')}
          </button>
        </div>
